...
def pushImage(){
    echo 'Building Image ...'
    sh "docker build -t 13.233.156.229:8082/sanskriti-portfolio:${BUILD_NUMBER} ."

    echo 'Pushing image to docker hosted rerpository on Nexus'

    withCredentials([usernamePassword(credentialsId: 'nexus', passwordVariable: 'PSW', usernameVariable: 'USER')]){
        sh "echo ${PSW} | docker login -u ${USER} --password-stdin 13.233.156.229:8082"
        sh "docker push 13.233.156.229/sanskriti-portfolio:${BUILD_NUMBER}"
    }
}
